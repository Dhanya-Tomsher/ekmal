        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.serviceslists.update', [
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="service_id" class="form-control"
                                    value="{{ old('name', $serviceslists->service_id) }}" required>
                                <x-input-error name='service_id' />
                            </div> 
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name</label>
                                <input type="text" name="name" class="form-control"
                                    value="{{ old('name', $serviceslists->name) }}" required>
                                <x-input-error name='name' />
                            </div>                       
                            <div class="form-group">
                                <label for="exampleInputEmail1">Description</label>
                                <input type="text" name="description" class="form-control"
                                    value="{{ old('description', $serviceslists->description) }}" required>
                                <x-input-error name='description' />
                            </div> 
                            <div class="form-group">
                                <label for="exampleInputEmail1">Position</label>
                                <input type="text" name="position" class="form-control"
                                    value="{{ old('position', $serviceslists->position) }}" required>
                                <x-input-error name='position' />
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sort Order</label>
                                <input type="number" name="sort_order" class="form-control"
                                    value="{{ old('sort_order', $serviceslists->sort_order) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control select2-single mb-3">
                                    <option {{ old('status', $serviceslists->status) == '1' ? 'selected' : '' }} value="1">
                                        Enabled
                                    </option>
                                    <option {{ old('status', $serviceslists->status) == '0' ? 'selected' : '' }} value="0">
                                        Disabled
                                    </option>
                                </select>
                ...
                <form id="deleteForm" method="POST"
                    action="{{ route('admin.serviceslists.destroy', [
                        'serviceslists' => $serviceslists,
                    ]) }}"
                    enctype="multipart/form-data">
                    @csrf
