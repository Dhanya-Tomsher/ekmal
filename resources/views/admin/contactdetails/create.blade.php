@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Create Contactdetails'])
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.contactdetails.store') }}" enctype="multipart/form-data">
                            @csrf
