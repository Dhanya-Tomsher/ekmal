  ...
  mySwiper = new Swiper(".swiper-container", {
    ...
    pagination: {
      ...
      renderBullet: function (index, className) {
        var test = $('.swiper-container').find('.swiper-slide').eq(index).find('i').prop('outerHTML');
...
$(window).on('load resize', function () {
  if ($(window).width() > 800) {
    const colAmount = $('.section-4cols .swiper-slide').length;
    console.log(colAmount);
    $('.section-4cols').addClass('js-has-' + colAmount + '-cols');
    ...
    $('.swiper-slide')
      .off('mouseenter').on('mouseenter', function () {
        ...
        gsap.to($('.swiper-slide .background-image'), { duration: 0.35, alpha: 0 });
        $(this).addClass('active')
        gsap.to($(this).find('.background-image'), { duration: 0.35, alpha: 1 });
      }).off('mouseleave').on('mouseleave', function () {
        $('.swiper-slide').removeClass('active')
        gsap.to($('.swiper-slide .background-image'), { duration: 0.35, alpha: 1 });
      });
  } else {
    if ($('.swiper-container-initialized').length == 0) {
      initSwiper();
  ...
  var child = $('.section-4cols .swiper-slide')[0];
